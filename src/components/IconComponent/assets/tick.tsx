...
export default (props: IIconAsset) => (
    <svg style={props.style} className={props.className} height={props.height} width={props.width} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 76.887 55.552" xmlSpace="preserve">
        <g id="Layer_15">
