...
export default (props: IIconAsset) => (
    <svg className={["h-icon-grid", props.className].join(" ")} style={props.style} height={props.height} width={props.width} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 359 359" xmlSpace="preserve">
        <g>
            <g>
