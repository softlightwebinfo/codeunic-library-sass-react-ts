...
export default (props: IIconAsset) => (
    <svg className={props.className} style={props.style} id="Capa_1" enableBackground="new 0 0 512.005 512.005" height={props.height} viewBox="0 0 512.005 512.005" width={props.width} xmlns="http://www.w3.org/2000/svg">
        <g>
            <path
