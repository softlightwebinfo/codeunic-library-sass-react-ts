...
export class Editor {
            ...
            case EditorDataEnum.LIST: {
                ...
                return (
                    <div
                        ...
                        onBlur={(e) => {
                            let items = [];
                            const dt = e.currentTarget.childNodes[0].childNodes;
                            dt.forEach((value, key) => {
                                items.push(value.textContent);
                            });
                            this.onInput(items, EditorDataEnum.LIST);
                        }}
                    >
    ...
    actionsPlus(onClick) {
        const data = [
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.PARAGRAPH}>
                <svg enableBackground="new 0 0 458.353 458.353" viewBox="0 0 458.353 458.353" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="m200.529 0c-78.975 0-143.235 64.26-143.235 143.235s64.26 143.235 143.235 143.235h57.294v171.882h28.647v-429.705h57.294v429.706h28.647v-429.706h28.647v-28.647zm57.295 257.824h-57.294c-63.183 0-114.588-51.391-114.588-114.588s51.404-114.589 114.587-114.589h57.294v229.177z"/>
                </svg>
            </li>,
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.TABLE}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.LIST}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.WARNING}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.CODE}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.LINK}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.IMAGE}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.RAW}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.HEADER}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.QUOTE}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.CHECKLIST}>
            ...
            <li className="ce-toolbox__button" data-tool={EditorDataEnum.DELIMITER}>
            ...
            <div className="ce-toolbox">
                {data.map((item, index) => {
                    return React.cloneElement(item, {
                        key: index, onClick: (e) => {
                            let data = e.currentTarget.getAttribute("data-tool");
                            onClick(data);
                        }
                    })
                })}
    ...
    addNewElement(e: EditorDataEnum) {
        let element = null;
        switch (e) {
            case EditorDataEnum.PARAGRAPH: {
    ...
    setList(items: string[]) {
        let a = this.data[this.focus].data as EditorDataList;
        a.items = items;
    }

    setImage(text: string) {
        let a = this.data[this.focus].data as EditorDataImage;
        a.file.url = text;
    }
}
